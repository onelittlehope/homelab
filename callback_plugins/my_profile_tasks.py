...
class CallbackModule(CallbackBase):
    ...
    def _record_task(self, task):
        ...
        """
        # JC 2023-02-24 - Don't display log msg at start of each task
    ...
    def v2_playbook_on_task_start(self, task, is_conditional):
        ...
        if(task._role is not None and task._role != self._current_role):
            ...
            self._display.display(self.__dict__.keys())
    ...
    # JC 2023-02-24 - Don't display log msg at start of each playbook
    # def playbook_on_setup(self):
    #     self._display.display(tasktime())

    def playbook_on_stats(self, stats):
        # JC 2023-02-24 - Don't display log msg at start of summary
        # self._display.display(tasktime())
